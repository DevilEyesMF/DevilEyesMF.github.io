document.addEventListener('DOMContentLoaded', () => {
    ...
    const acceptBtn = document.getElementById('ig-embed-accept-cookies');
...
function loadInstagramEmbed() {
    ...
    if (container) {
        ...
        <blockquote class="instagram-media"
            data-instgrm-permalink="https://www.instagram.com/captain.claes/" data-instgrm-version="12"
            ...
            <div style="padding:16px;"> <a id="main_link" href="captain.claes/"
